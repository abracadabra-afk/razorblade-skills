...
> **SUPERSEDED FOR WIW — 2026-09-12.** The structural commitment now runs as [[WORKFLOWS/wiw-story-engine]] **Step 2 Want vs Inescapability**, writing `spine.md` (which replaces `shape.md` + `blueprint.md`). The rung-walk down to the flaw is gone: the pillars are the want shown in the first physical move, the rationale, the Inescapable as force + truth, the Story as must / or-else, and 3–4 setting off-details. This doc's 2026-09-11 PROVISIONAL banner is discharged. Doc and install untouched pending a live run of the engine; do not run this on a new WIW episode. Provenance: [[WORKFLOWS/intents/wiw-story-engine]].
