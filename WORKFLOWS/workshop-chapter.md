...
Resolve the chapter folder (ask if not named). Determine the working text (`draft.md` → newest slate clean-draft → dictation) and note how rough it is.
